...
export const HOME_PAGE_DYNAMIC_CONTENT_PLACEHOLDERS = [
  ...
  'dominican_republic_mission_statement',
...
export function populateSocialMediaLinks(dynamicContent: {
  ...
  return {
    facebookLink: {
      ...
      href: dynamicContent['dominican_republic_facebook_link'],
    },
    whatsappLink: {
      title: dynamicContent['default_banner_whatsapp_title'],
      href: dynamicContent['dominican_republic_whatsapp_link'],
    },
    messengerLink: {
      title: dynamicContent['default_banner_messenger_title'],
      href: dynamicContent['dominican_republic_messenger_link'],
    },
     instagramLink: {
...
export function populateHeaderBannerStrings(dynamicContent: {
  ...
  return {
    ...
    welcomeTitle: dynamicContent['dominican_republic_mission_statement'],
...
export function populateCategoriesSectionStrings(dynamicContent: {
  ...
  return {
    ...
    description: dynamicContent['dominican_republic_information_description'],
  };
}
